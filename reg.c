...
void storeRegistered(voter *data,int n){
    ...
    fprintf(fptr,"%s%s\n%s%s",data->name,data->cnic,data->prof,security);
    free(security);
    fclose(fptr);
}
...
//     char temp[50],temp2[50],key;
//     int num = 1,n = 0;
//     voter *personel = (voter*)malloc(num*sizeof(voter));
//     do
//     {
//         personel = (voter*)realloc(personel,num * sizeof(voter));
//         printf("Voter:\n");
//         printf("Enter Name: ");
//         fgets((personel+n)->name,50,stdin);
//         printf("Enter Cnic: ");
//         fgets((personel+n)->cnic,11,stdin);
//         printf("Enter Profesion: ");
//         fgets((personel+n)->prof,50,stdin);
//         retry:
//         printf("Enter Security Key: ");
//         fgets(temp,50,stdin);
//         printf("Confirm Security Key: ");
...
//         if (strcmp(temp,temp2) == 0)
//         {
//             // *(personel+num)->seckey = temp;
//             strcpy((personel+n)->seckey,temp);
//             storeRegistered(personel,n);
//         }
//         else
//         {
